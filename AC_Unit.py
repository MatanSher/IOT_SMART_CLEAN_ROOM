...
ac_topic = 'IOT/FinalProject/SmartCleanRoom/Pub'
global ON
ON = False
...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self,mc):
        ...
        self.ePushtbtn.setToolTip("Clean Room 1")
        ...
        formLayot.addRow("Room number",self.ePushtbtn)
    ...
    def update_btn_state(self,CleanRoomNum):
        if(CleanRoomNum[0]=='-' or CleanRoomNum.isdigit()):
         self.eTemperature.setText(CleanRoomNum)

        
        global ON

        if "Clean Room 1" in CleanRoomNum:
            print("Moving to Clean Room 1")
            self.ePushtbtn.setStyleSheet("background-color: pink")
            self.ePushtbtn.setToolTip("Clean Room 1")
            self.ePushtbtn.setText("Clean Room 1")
            ON = True

        elif "Clean Room 2" in CleanRoomNum:
            print("Moving to Clean Room 2")
            self.ePushtbtn.setStyleSheet("background-color: orange")
            self.ePushtbtn.setToolTip("Clean Room 2")
            self.ePushtbtn.setText("Clean Room 2")
            ON = True

        elif "Clean Room 3" in CleanRoomNum:
            print("Moving to Clean Room 3")
            self.ePushtbtn.setStyleSheet("background-color: gray")
            self.ePushtbtn.setToolTip("Clean Room 3")
            self.ePushtbtn.setText("Clean Room 3")
            ON = True

        elif "Clean Room 4" in CleanRoomNum:
            print("Moving to Clean Room 4")
            self.ePushtbtn.setStyleSheet("background-color: purple")
            self.ePushtbtn.setToolTip("Clean Room 4")
            self.ePushtbtn.setText("Clean Room 4")
            ON = True

        elif "Clean Room 5" in CleanRoomNum:
            print("Moving to Clean Room 5")
            self.ePushtbtn.setStyleSheet("background-color: yellow")
            self.ePushtbtn.setToolTip("Clean Room 5")
            self.ePushtbtn.setText("Clean Room 5")
            ON = True
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        # set up main window
        self.setGeometry(1200, 600, 650, 300)
        self.setWindowTitle('Air Conditioner Clean Rooms Unit')
